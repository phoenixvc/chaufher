...
┌──────────────┐     ┌──────────────┐     ┌──────────────┐
│  PWA Client  │────▶│  API Gateway │────▶│   Backend    │
│  (Browser)   │     │  (App Service│     │   Services   │
└──────────────┘     │   + CDN)     │     │ (App Service)│
                     └──────────────┘     └──────┬───────┘
                                                  │
                     ┌────────────────────────────┼────────────┐
...
| **Web Push (VAPID)** | Push notifications (PWA) | VAPID keys | Key Vault |
...
- Cache tokens securely (browser storage with appropriate security)
...
- Update subscription on refresh
...
For PWA/web engineers, see **[MOBILE_CHECKLIST.md](MOBILE_CHECKLIST.md)** for detailed integration steps.
...
**Jurie** - Platform Lead & Infrastructure Owner
...
- **Notion**: ChaufHER Infra Space for collaborative documentation
