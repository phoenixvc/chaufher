...
Full user personas are available in the [user_personas.md](user_personas.md) document.
...
2. For design principles and constraints, please refer to: [DESIGN_GUARDRAILS.md](DESIGN_GUARDRAILS.md)
3. For architecture decisions, please refer to: [ADR Index](../adr/)
